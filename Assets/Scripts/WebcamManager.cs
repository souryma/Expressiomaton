...
public class WebcamManager : MonoBehaviour
{
    ...
    /// </summary>
    private Texture2D ProcessTexture(WebCamDevice webCamDevice, WebCamTexture input, FaceProcessorLive<Texture2D> processor)
    {
    ...
    /// </summary>
    private OpenCvSharp.Unity.TextureConversionParams ReadTextureConversionParameters(WebCamDevice webCamDevice, WebCamTexture webCamTexture)
    {
